...
public class SU21071926 {
    ...
    //: Read in a comamnd line argument that states whether the program will be in either terminal
                ...
                */
                switch(input) {
                    ...
                    case 3: //: Read in chosen column
							...
							//: Check that value is within the given bounds, check that the data is numeric
							//: Play teleport disc in chosen column and reduce the number of teleporters left
							//: Check that player has teleport discs left to play, otherwise print out an error message
                            break;
                    ...
                    case 4: //StdOut.println("Choose a column to play in:");
							...
							//: Check that value is within the given bounds, check that the data is numeric
							//: Play Colour Change disc in chosen column and reduce the number of colour changers left
							//: Check that player has Colour Change discs left to play, otherwise print out an error message
                            break;
					...
					default: //: Invalid choice was made, print out an error message but do not switch player turns
...
//General layout
    ...
    private static void winScreen(String st) {
		//  Auto-generated method MAKE SURE to use the String
 ...
 */
    ...
    public static void Display (int [][] grid) {
        //: Display the given board state with empty spots as *, player 1 as R and player 2 as Y. Shows column and row numbers at the top.
    	Debug("display");
    	String space = " ";
...
public static boolean endGui(String mes,boolean again) {
    ...
    public static int [][] Play (int i, int [][] grid, boolean player1) {
        //: Play a normal disc of the given colour, if the column is full, print out the message: "Column is full."
 ...
 */
    ...
    public static int [][] Bomb (int i, int [][] grid, boolean player1) {
        //: Play a bomb in the given column and make an explosion take place. Discs should drop down afterwards. Should not affect the
        //      board state if there's no space in the column. In that case, print the error message: "Column is full."
    ...
    public static int [][] Teleport (int i, int [][] grid, boolean player1) {
        //: Play a teleporter disc that moves the targeted disc 3 columns to the right. If this is outside of the board
        //      boundaries, it should wrap back around to the left side. If the column where the targeted disc lands is full,
        //      destroy that disc. If the column where the teleporter disc falls is full, play as normal, with the teleporter
        //      disc replacing the top disc.
    ...
    public static int [][] Colour_Changer (int i, int [][] grid, boolean player) {
        //: Colour Change: If the colour change disc lands on top of another disc, it changes the colour of that
